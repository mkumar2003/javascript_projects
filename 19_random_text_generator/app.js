...
console.log(result);
  ...
  form.addEventListener("submit",function(e){
    ...
    //here value received in value is in string format but we need number /*/strings are represted in dark black color in console and number in blue.
    ...
    if(isNaN(value) || value <=0 || value>9){
        ...
        tempText =  tempText.map(function(obj){
            return `<p class="result"> ${obj} <\p>`
        }).join("");
